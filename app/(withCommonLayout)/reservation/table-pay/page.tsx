...
const TablePayContent = () => {
  ...
  const handlePayment = async (method: "SSL" | "Stripe") => {
    ...
    try {
      const endpoint =
        method === "SSL"
          ? "/bookings/create-ssl-booking"
          : "/bookings/create-stripe-booking";
          ...
          <div className="lg:col-span-7 space-y-8">
            <div className="bg-white/80 backdrop-blur-xl rounded-[28px] p-10 border border-gray-200 shadow-lg">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-between border-b pb-4">
                  <div className="flex items-center gap-3 text-gray-500 font-bold text-xs uppercase">
                    <Users size={16} /> Selected Tables
                  </div>
                  <span className="font-black text-[#1D3A15]">
                    {tableIds.length} Table(s)
                  </span>
                </div>
              </div>
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="bg-white/90 backdrop-blur-xl rounded-[28px] p-10 border border-gray-200 shadow-lg">
              <div className="flex items-center gap-3 mb-8">
                ...
                <h3 className="text-xs font-extrabold text-[#1D3A15] uppercase tracking-widest">
                  Payment Methods
                </h3>
              </div>
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <CreditCard
                    size={24}
                    className="text-gray-300 group-hover:text-[#1D3A15]"
                  />
                </button>
              </div>
            </div>
