...
const LatestBlog = () => {
    ...
    if (loading) {
        return <div className="py-20 text-center font-bold text-[#1B4314]">Loading Latest Post...</div>;
    }
            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
                    ...
                    <div className="w-full lg:w-1/2 flex flex-col items-start text-left">
                        ...
                        {/* সাবটাইটেল (Optional) */}
                        {blog.blogSubtitle && (
                            <p className="text-[#1B4314] font-medium mb-4 italic">
                                {blog.blogSubtitle}
                            </p>
                        )}
                        ...
                        {/* অথর প্রোফাইল (স্ট্যাটিক রাখা হয়েছে আপনার ডেটাতে নেই বলে) */}
