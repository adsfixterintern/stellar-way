                    ...
                    >
                      <td className="p-5">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="font-black text-gray-800 text-[12px] tracking-tighter uppercase">
                      ...
                      <td className="p-5 text-center">
                        <span
                          className={`px-3 py-1 rounded-full text-[9px] font-black uppercase tracking-wider ${order.paymentStatus === "paid" ? "bg-green-100 text-green-600" : "bg-red-50 text-red-500"}`}
                        >
                          {order.paymentStatus}
                        </span>
                      </td>
