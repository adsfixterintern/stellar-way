                  ...
                  <tr key={booking._id} className="hover:bg-gray-50/40 transition-colors">
                    <td className="p-5 ">
                      <div className="flex items-center gap-4">
                        ...
                        <div className="text-[15px]">
                          ...
                          <p className=" text-gray-400 text-[12px] font-black mt-1">
                            #{booking.transactionId?.slice(-10).toUpperCase()}
                          </p>
                        </div>
                      </div>
                    </td>
                    ...
                    <td className="p-5 text-center">
                      <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-gray-50 rounded-full border border-gray-100">
                        <IoTicketOutline size={14} className="text-primary" />
                    ...
                    <td className="p-5 text-center">
                      ...
                      <p className="text-[10px] text-gray-400 font-bold uppercase mt-1 tracking-tighter">{booking.paymentMethod}</p>
                    </td>

                    <td className="p-5 text-right text-primary font-semibold">
                      <p className="">৳{booking.totalAmount}</p>
                      <button 
                        onClick={() => handleOpenModal(booking)}
                        className="text-[10px] uppercase tracking-widest mt-1 hover:underline underline-offset-4"
                      >
                        View Details
                      </button>
                    </td>
