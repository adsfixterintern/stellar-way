...
const CategoryPage: React.FC = () => {
  ...
  const handleCreateCategory = async (e: FormEvent): Promise<void> => {
    e.preventDefault();
    // if (!catName) return toast.error("Please provide category name");
    ...
    try {
      ...
      const { data } = await axios.post(`${BASE_URL}/categories/create-category`, payload);
                ...
                {loading ? (
                  ...
                  <tr key={cat._id} className="hover:bg-gray-50/30 transition-colors group">
                    ...
                    <td className="p-5 text-right">
                      <button onClick={() => handleDelete(cat._id)} className="p-2.5 text-gray-300 hover:text-red-500 hover:bg-red-50 rounded-xl transition-all"><IoTrashOutline size={20} /></button>
                    </td>
                  </tr>
                ))}
              </tbody>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="relative bg-white w-full max-w-md shadow-2xl rounded-[10px] overflow-hidden animate-in fade-in zoom-in duration-200">
            <div className="flex justify-between items-center p-6 border-b border-gray-50">
              <h2 className="text-xl font-black text-gray-900 tracking-tight">Add Category</h2>
            ...
            <form onSubmit={handleCreateCategory} className="p-8 space-y-5">
              ...
              <div className="pt-4">
                ...
                >
                  {btnLoading ? "Processing..." : "Create Category"}
                </button>
              </div>
            </form>
          </div>
