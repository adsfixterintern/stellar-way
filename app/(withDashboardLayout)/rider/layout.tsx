...
import { 
  LayoutDashboard, History, User, LogOut, Bell, Menu, X, Trash2 
} from "lucide-react";
                          ...
                          {notifications.map((n) => (
                            ...
                            >
                              <button 
                                ...
                                className="absolute top-4 right-4 p-1 text-gray-300 hover:text-red-500 transition-all rounded-md opacity-0 group-hover:opacity-100"
                              >
                                <X size={14} />
                              </button>
