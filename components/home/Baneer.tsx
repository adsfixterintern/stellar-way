  ...
  return (
    <div className="relative overflow-hidden min-h-[700px]">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          src="https://res.cloudinary.com/dn5t9fhya/image/upload/f_auto,q_auto,w_1600/v1773563794/3afac52152e35e30010981a1553eb6b0add11db0_y6nelx.png"
          alt="Banner"
          fill
          priority
          sizes="100vw"
      ...
      <div className="relative z-20 max-w-7xl mx-auto pt-32 flex flex-col lg:flex-row items-center justify-between gap-10">
          ...
          <div className="space-y-4 text-center lg:text-left">
            <h1 className="text-white text-5xl lg:text-7xl font-bold leading-[1.1]">
              ...
              <span className="flex items-center justify-center lg:justify-start gap-3">
                Exquisite
                <span className="relative inline-flex items-center justify-center w-24 h-12 rounded-full overflow-hidden border border-white/20 cursor-pointer">
                  <Image
        ...
        <div className="relative w-full lg:w-1/2 flex justify-center lg:justify-end mt-10 lg:mt-0">
          <div className="relative w-175 h-172">
            <Image
              src="https://res.cloudinary.com/dn5t9fhya/image/upload/f_auto,q_auto,w_800/v1773564244/3ae59afda4b6c04a1e44916237d3441e07dd5c93_xtonf9.png"
              alt="Plate of Food"
              fill
              priority
