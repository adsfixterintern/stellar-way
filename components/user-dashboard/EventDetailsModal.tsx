...
const EventDetailsModal: React.FC<EventDetailsModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm transition-all print:bg-white print:p-0 print:static">
      {/* --- Ticket Print CSS & Custom Scrollbar --- */}
      <style jsx global>{`
        @media print {
          body * {
            visibility: hidden;
      ...
      {/* Main Ticket Modal */}
      <div className="bg-white w-full max-w-md rounded-[35px] shadow-2xl overflow-hidden relative animate-in zoom-in duration-200 printable-ticket print:max-w-full print:rounded-none flex flex-col max-h-[90vh]">
        {/* Fixed Header Section */}
        <div className="bg-[#1A4E11] p-6 text-center text-white shrink-0 print:bg-white print:text-black print:border-b">
        ...
        <div className="p-8 space-y-6 overflow-y-auto custom-scrollbar flex-grow print:overflow-visible">
          {/* QR Code Section */}
          ...
          {/* Transaction Info */}
          <div className="bg-[#F9FBFA] p-4 rounded-xl border border-gray-100 print:bg-white shrink-0">
          ...
          {/* Download Button (Placed inside scroll for better mobile UX or can be outside) */}
          <button
            onClick={onDownload}
            className="w-full flex items-center justify-center gap-2 py-4 bg-[#1A4E11] text-white rounded-2xl text-[11px] font-black uppercase tracking-widest hover:opacity-90 transition-all shadow-lg shadow-green-900/10 no-print sticky bottom-0"
          >
