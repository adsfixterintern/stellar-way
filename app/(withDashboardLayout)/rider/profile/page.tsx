...
const UserProfile = () => {
  ...
  const fetchProfile = async () => {
    ...
    try {
      ...
      if (result.success && Array.isArray(result.data)) {
        const matchedRider = result.data.find(
          (r: any) =>
  ...
  const handleChangePassword = async (e: React.FormEvent) => {
    ...
    // ৬ ডিজিট এর কম হলে এরর দেখাবে
    if (passwordData.newPassword.length < 6) {
      return toast.error("Password must be at least 6 digits long!");
    }
      ...
      <div className="max-w-6xl mx-auto">
        <div className="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
          ...
          <div className="flex gap-3">
            ...
            >
              {isEditing ? (
                <IoCloseOutline size={18} className="inline mr-1" />
              ) : (
                <IoPersonOutline size={16} className="inline mr-1" />
              )}
            ...
            <div className="bg-white p-10 rounded-[40px] border border-gray-100 text-center relative shadow-2xl">
              ...
              <div className="relative inline-block mb-6">
                <div className="w-40 h-40 rounded-[50px] border-8 border-gray-50 overflow-hidden bg-gray-100 mx-auto flex items-center justify-center">
                  <img
                    src={
                      imagePreview || "https://ui-avatars.com/api/?name=Rider"
                    }
                    alt="Profile"
              ...
              <div className="mt-6 flex flex-col gap-3">
                ...
                <div
                  className={`px-4 py-1.5 text-[9px] font-black uppercase rounded-full border mx-auto transition-all ${formData.isBusy ? "bg-orange-50 text-orange-600 border-orange-100" : "bg-blue-50 text-blue-600 border-blue-100"}`}
                >
          ...
          <div className="lg:col-span-8">
            {showPasswordForm ? (
              <div className="bg-white p-10 md:p-12 rounded-[40px] border border-gray-100 shadow-2xl animate-in fade-in duration-300">
                <h3 className="text-xs font-black uppercase tracking-[0.3em] text-black border-b pb-4 mb-8">
                  Update Security
                </h3>
                <form onSubmit={handleChangePassword} className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full bg-gray-50 border-2 border-gray-50 rounded-[22px] px-6 py-4 text-sm font-bold focus:border-black outline-none transition-all"
                    />
                  </div>
                  ...
                  <button
                    ...
                    type="submit"
                    className="bg-black text-white px-10 py-4 rounded-[22px] text-[10px] font-black uppercase tracking-widest shadow-xl transition-all hover:scale-105 active:scale-95 disabled:bg-gray-400"
                  >
              ...
              <form
                ...
                className="bg-white p-10 md:p-12 rounded-[40px] border border-gray-100 shadow-2xl"
              >
                <h3 className="text-xs font-black uppercase tracking-[0.3em] text-[#1A4E11] border-b pb-4 mb-8">
                  Personal & Rider Info
                </h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full bg-gray-50 border-2 border-gray-50 rounded-[22px] px-6 py-4 text-sm font-bold focus:border-[#1A4E11] outline-none transition-all disabled:opacity-60"
                    />
                  </div>
                  <div className="space-y-2">
                    <label className="text-[10px] font-black uppercase text-gray-400 ml-1">
                  ...
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      className="w-full bg-gray-50 border-2 border-gray-50 rounded-[22px] px-6 py-4 text-sm font-bold focus:border-[#1A4E11] outline-none appearance-none disabled:opacity-60"
                    >
                ...
                <h3 className="text-xs font-black uppercase tracking-[0.3em] text-gray-300 border-b pb-4 mb-8">
                ...
                {isEditing && (
                  <div className="space-y-6 pt-4 border-t border-gray-50">
                    <button
                      type="button"
                      onClick={() =>
                        setFormData({ ...formData, isBusy: !formData.isBusy })
                      }
                    ...
                    <button
                      type="submit"
                      disabled={updateLoading}
                      className="w-full md:w-auto bg-[#1A4E11] text-white px-12 py-5 rounded-[25px] text-[11px] font-black uppercase tracking-[0.3em] hover:scale-[1.02] active:scale-95 transition-all shadow-xl disabled:bg-gray-400"
                    >
                      {updateLoading
                        ? "Updating Details..."
                        : "Save All Changes"}
