 ...
 * Basic props to handle children components.
 */
interface DashboardLayoutProps {
...
const DashboardLayout: React.FC<DashboardLayoutProps> = ({ children }) => {
   ...
   * Logic for both Desktop and Mobile view.
   */
      ...
      <div className="mb-10 flex justify-center">
        <Link href="/">
          <div className=" w-32 h-10 rounded flex items-center justify-center text-xs  font-bold uppercase tracking-widest">
            {/* Replace with <img src="/assets/logo.png" /> */}
    ...
    <div className="flex min-h-screen bg-[#FDFCFD] font-sans antialiased">
      ...
      <div className="flex-1 lg:ml-64 flex flex-col min-w-0">
        ...
        <header className="h-20 bg-white/90 backdrop-blur-md border-b border-gray-100 flex items-center justify-between px-6 sticky top-0 z-40">
          ...
          <div className="flex items-center gap-6">
            ...
            {/* Profile Placeholder (Ready for dynamic data) */}
      ...
      {isSidebarOpen && (
        <div className="lg:hidden fixed inset-0 z-[60] flex">
          ...
          {/* Mobile Drawer */}
          <div className="relative w-72 h-full bg-white shadow-2xl animate-in slide-in-from-left duration-300 ease-in-out">
            <button
