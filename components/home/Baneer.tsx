  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        {/* Gradient Overlay added here (#031100CC / 80% opacity) */}
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-6 pt-32 flex flex-col lg:flex-row items-center justify-between gap-10">
        ...
        <div className="relative w-full lg:w-1/2 flex justify-center lg:justify-end mt-10 lg:mt-0">
          <div className="relative w-[700px] h-[689px]">
            <Image 
            ...
            <div className="absolute top-28 -left-6 md:-left-6 bg-white rounded-2xl px-8 py-4 shadow-2xl flex items-center gap-3 animate-bounce-slow">
              <div className="">
                <Image 
                  width={50}
                  height={50}
                  alt='Delivery'
                  src={"https://res.cloudinary.com/dn5t9fhya/image/upload/v1773566201/8cb4cec463a62b8b2a4551d6589e6c606fb5d2b6_czotqm.png"}
                />
              </div>
              <div>
            ...
            <div className="absolute bottom-16 -right-2 md:right-10 bg-white rounded-2xl p-3 md:p-4 shadow-2xl flex items-center gap-3">
